...
<div class="card mt-5">
    <div class="card-body">
        <h3>Разработчик</h3>
        <p>Александр Гейлаш</p>
        <h3>Описание проекта</h3>
        <p>Проект "Offer Manager" предназначен для подготовки коммерческих предложений клиентам по экспедированию перевозок. Для работы есть клиенты (добавить, удалить, отредактировать), провайдеры (добавить, удалить, отредактировать), услуги провайдеров (добавить, удалить, отредактировать), запросы клиентов (добавить, удалить, отредактировать), ответы клиентам (добавить, удалить, отредактировать). Входные данные должны валидироваться. При удалении, дабовлении, редактировании данных должны выдываться сообщения</p>
        ...
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">Таблица: услуги провайдеров (services: many to one)</h4>
                <div class="single-table">
                    <div class="table-responsive">
                        <table class="table text-center">
                            <thead class="text-uppercase bg-secondary">
